...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\DogeCash Core\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/DogeCash Core/';
  if (isLinux) dataDir = process.env.HOME + '/.dogecash/';
}
